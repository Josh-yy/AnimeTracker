<section class="flex flex-col gap-6 mb-[5em]">
    <div class="flex items-end justify-between">
        ...
        <a href="/view-more?anime=bypopularity" id="tv-series-view-more-button" class="flex items-center text-[var(--tint-text-white)] hover:text-white cursor-pointer">View more <i class='bx  bx-chevron-right' ></i> </a>
    </div>
    <div id="grid-container" class="flex gap-2">
        <?php foreach ($popularAnime['data'] as $index => $anime): ?>
            <div id="tv-series-image" class="flex-1 relative group">
                ...
                <div class="hover-details group-hover:flex z-[100] bottom-[50%]  absolute p-3 flex-col gap-3 bg-[var(--tint-background-color)] hidden">
                    <div>
