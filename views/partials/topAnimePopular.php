    ...
    <div class="flex gap-2">
        <?php foreach ($popularAnime['data'] as $index => $anime): ?>
            <div id="tv-series-image" class="flex-1 relative group">
                ...
                <div id="hover-details" class="group-hover:flex z-[100] bottom-[50%] <?= $index < count($popularAnime['data']) - 2 ? 'left-[110%]' : 'right-[110%]' ?>  absolute p-3 flex-col gap-3 bg-[var(--tint-background-color)] hidden">
                    <div>
